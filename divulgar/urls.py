...
urlpatterns = [
    ...
    path('api_adocoes_solicitadas_por_raca/', views.api_adocoes_solicitadas_por_raca, name="api_adocoes_solicitadas_por_raca"),
    #path('api_adocoes_aceitas_por_raca/', views.api_adocoes_aceitas_por_raca, name="api_adocoes_aceitas_por_raca")
]
